...
Eigen::Matrix3d euler2Rotation( Eigen::Vector3d  eulerAngles)     //    欧拉角转旋转矩阵
{
...
Eigen::Matrix3d eulerRates2bodyRates(Eigen::Vector3d eulerAngles)     //   欧拉速率 转 载体系速率
{
    double roll = eulerAngles(0);
    double pitch = eulerAngles(1);
...
{
    gyro_bias_ = Eigen::Vector3d::Zero();                       //   gyro 零偏
    acc_bias_ = Eigen::Vector3d::Zero();                         //   accel 零偏
}
...
MotionData IMU::MotionModel(double t)                       //   运动模型
{
