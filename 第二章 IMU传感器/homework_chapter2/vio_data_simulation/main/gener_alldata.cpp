...
int main(){
    ...
    imuGen.testImu_euler("imu_pose.txt", "imu_int_pose.txt");     // test the imu data, integrate the imu data to generate the imu trajecotry
    imuGen.testImu_euler("imu_pose_noise.txt", "imu_int_pose_noise.txt");
